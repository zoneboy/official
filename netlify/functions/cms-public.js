...
export const handler = async (event) => {
  ...
  try {
    const sql = getDB();
    const [boardOfTrustees, leaders, regional, stateCoords, events, articles] = await Promise.all([
    ...
    return json({ boardOfTrustees, leaders, regional, stateCoords, events, articles });
  } catch (e) {
