...
const LINKS = [
  ...
  { title: "Resources", items: [{ label: "Membership Guide", page: "membership" }, { label: "Resources", page: "resources" }, { label: "Privacy Policy" }, { label: "Terms of Service" }] },
];
const SOCIALS = [
    ...
    <footer style={{ background: "#f5f5f4", paddingTop: isMobile ? 48 : 80, paddingBottom: 40 }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "0 20px" : "0 32px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr 1fr", gap: isMobile ? 32 : 48 }}>
        ...
        <div>
          ...
          <address style={{ fontStyle: "normal", fontSize: 13, color: "#64748b", lineHeight: 1.8 }}>F3, Global Plaza, Kaura District<br />Abuja, FCT, Nigeria<span style={{ display: "block", marginTop: 14, color: COLORS.primary, fontWeight: 700 }}>ran@recyclersassociation.org<br />+234 907 981 9777</span></address>
        </div>
      </div>
